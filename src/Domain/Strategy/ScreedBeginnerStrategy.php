...
final class ScreedBeginnerStrategy implements CalculationStrategyInterface
{
    public const BEGINNER_PERCENT = 15.0;
    private const PERCENT_BASE = 100;

    public function __construct(
        private readonly ScreedNormativeStrategy $baseStrategy = new ScreedNormativeStrategy()
    ) {
    }
