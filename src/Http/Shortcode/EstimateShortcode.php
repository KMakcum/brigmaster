...
final class EstimateShortcode
{
    ...
    private function renderEstimator(string $calculator, string $title): string
    {
        ...
        ob_start();
        ?>
        <div class="brigmaster-estimator" data-calculator="<?php echo esc_attr($calculator); ?>">
            ...
            <form class="brigmaster-estimate-form" novalidate>
                ...
                <?php if ($calculator === 'concrete') : ?>
                    <div class="brigmaster-estimator__field-group" data-field-group="concrete-subtype">
                        <div class="brigmaster-estimator__field">
                    ...
                    <div class="brigmaster-estimator__field-group" data-field-group="concrete-slab">
                        <div class="brigmaster-estimator__field">
                    ...
                    <div class="brigmaster-estimator__field-group brigmaster-estimator__field-group--hidden" data-field-group="concrete-strip">
                        <div class="brigmaster-estimator__field">
